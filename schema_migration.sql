...
DROP FUNCTION IF EXISTS get_user_conversations(UUID, TIMESTAMPTZ);
DROP FUNCTION IF EXISTS get_conversation_messages(UUID, UUID, INTEGER, TIMESTAMPTZ);
DROP FUNCTION IF EXISTS get_conversation_messages(UUID, UUID, INTEGER, TIMESTAMPTZ, TIMESTAMPTZ);
